...
class _Screen4State extends State<Screen4> {
  ...
  TextStyle faqhead = const TextStyle(fontWeight: FontWeight.w500 ,color: Color.fromARGB(255, 94, 94, 94));
            ...
            children: [
              ...
              Padding(
                ...
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    const Text("Need help? Get in touch",style: TextStyle(
                      fontWeight: FontWeight.bold,
                      fontSize: 18
                    ),),
                    const SizedBox(height: 10,),
              ...
              Padding(
                ...
                child: Row(
                  ...
                  children:
                  [TextButton(onPressed: (){}, child: const Text("Select Domain",style: TextStyle(
                    fontSize: 16,
